...
import { generateFakeProductsFromAPI, uploadProductsToFirestore } from '../../../lib/config/seed/createData';
...
//                         <img className="mx-auto hidden h-full dark:block" src={producto.imageUrl} alt="" />
//                     </a>
//                 </div>
//                 <div className="pt-6">
//                     <a href="#" className="text-lg font-semibold leading-tight text-gray-900 hover:underline dark:text-white">{producto.name}</a>
...
//                         {/* <p className="text-sm font-medium text-gray-900 dark:text-white">{producto.rating.rate}</p> */}
//                         <p className="text-sm font-medium text-gray-500 dark:text-gray-400">({producto.rating.views})</p>
//                     </div>
